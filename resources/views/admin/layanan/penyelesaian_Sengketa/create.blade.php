    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <div>
              <h5 class="card-title">Tambah Prosedur Penyelesaian Sengketa</h5>
            </div>
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{route('admin-penyelesaianSengketa.store')}}" enctype="multipart/form-data">
                    @csrf
