        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <a href="{{ url('admin-pengajuanKeberatan/create') }}" class="btn btn-primary py-2 px-3 fs-normal float-right mb-3 shadow-sm"></span>Tambah Data</a>
                ...
                <tbody>
                  @forelse ($pengajuanKeberatan as $item)    
                      <tr>
                          ...
                          <td>{{ $item->file }}</td>
                          <td>
                            <form action="/admin-pengajuanKeberatan/{{ $item->id }}" method="post">

                                <a href="/admin-pengajuanKeberatan/{{ $item->id }}/edit" class="btn btn-primary text-light">ubah</a>
