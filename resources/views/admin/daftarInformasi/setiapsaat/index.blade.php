        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <a href="{{ url('admin-setiapsaat/create') }}" class="btn btn-primary py-2 px-3 fs-normal float-right mb-3 shadow-sm"></span>Tambah Data</a>
                ...
                <tbody>
                  @forelse ($setiapsaat as $item)    
                      <tr>
                          ...
                          <td>
                            <form action="/admin-setiapsaat/{{ $item->id }}" method="post">

                                <a href="/admin-setiapsaat/{{ $item->id }}/edit" class="btn btn-primary text-light">ubah</a>
                      ...
                      <tr>
                          <td colspan="4" align="center">
                              Daftar Informasi Setiap Saat Kosong
                          </td>
                      </tr>
                  @endforelse
