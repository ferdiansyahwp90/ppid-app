...
<html lang="en">
    <head>
        ...
        <meta name="viewport" content= "width=device-width, initial-scale=1.0, maximuum-scale=1.0"/>
        <meta content="" name="keywords"/>
        <meta content="" name="description"/>

        <!-- Favicon -->
        <link href="assets/img/logopemkab.png" rel="icon">
                ...
                <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="w-100" src="assets/img/kantor.jpg" alt="Image">
                        ...
                        <div class="carousel-item">
                            <img class="w-100" src="assets/img/alur.jpg" alt="Image">
                            <div class="carousel-caption">
                                <div class="container">
                                    <div class="row justify-content-center">
                                        <div class="col-lg-7">
                                            <h1 class="display-1 text-white mb-5 animated slideInDown">Alur Permohonan Informasi Layanan Publik</h1>
                ...
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                    <div class="bg-white shadow d-flex align-items-center h-100 px-5" style="min-height: 160px;">
                        <div class="d-flex">
                            ...
                            <div class="ps-3">
                                <h4>Tanpa Ada Biaya</h4>
                                <span>Memberikan informasi publik secara transparan dan tanpa biaya tambahan</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white shadow d-flex align-items-center h-100 px-5" style="min-height: 160px;">
                        <div class="d-flex">
                            ...
                            <div class="ps-3">
                                ...
                                <span>Memiliki tim yang andal dan responsif terhadap kebutuhan publik</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <div class="bg-white shadow d-flex align-items-center h-100 px-5" style="min-height: 160px;">
                        <div class="d-flex">
                            ...
                            <div class="ps-3">
                                <h4>Melayani Saat Jam Kerja</h4>
                                <span>Melayani informasi sesuai dengan prosedur saat jam kerja selama hari Senin - Jum'at </span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row g-5 align-items-end">
                    <div class="col-lg-3 col-md-5 wow fadeInUp" data-wow-delay="0.1s">
                        <img class="img-fluid rounded" data-wow-delay="0.1s" src="assets/img/logopemkab.png">
                    </div>
        ...
        <div class="container py-5">
            <div class="row g-5" >
                <div class="col-sm-6 col-lg-3 text-center wow fadeIn" data-wow-delay="0.1s">
                    <h1 class="display-4 text-white" data-toggle="counter-up">7854+</h1>
                    <span class="fs-5 fw-semi-bold text-light">Permintaan Informasi</span>
                </div>
                <div class="col-sm-6 col-lg-3 text-center wow fadeIn" data-wow-delay="0.3s">
                    <h1 class="display-4 text-white" data-toggle="counter-up">9999+</h1>
                    <span class="fs-5 fw-semi-bold text-light">Pelayanan Informasi</span>
                </div>
                <div class="col-sm-6 col-lg-3 text-center wow fadeIn" data-wow-delay="0.5s">
                    <h1 class="display-4 text-white" data-toggle="counter-up">9999+</h1>
                    <span class="fs-5 fw-semi-bold text-light">Konsultasi Informasi</span>
                </div>
                <div class="col-sm-6 col-lg-3 text-center wow fadeIn" data-wow-delay="0.7s">
                    <h1 class="display-4 text-white" data-toggle="counter-up">5000+</h1>
                    <span class="fs-5 fw-semi-bold text-light">Menyelesaikan sengketa informasi</span>
                </div>
            </div>
        </div>
    </div>
