...
<div class="container">       
        <div class="text-center">
              ...
              <form action="/action_page.php">
                ...
                <label for="lname">No. KTP/SIM/Paspor:</label>
                <input type="text" id="lname" name="lname"><br>
                
                <label for="fname">Pekerjaan:</label>
                <input type="text" id="fname" name="fname"><br>
                
                <label for="lname">No. Telp/Email:</label>
                <input type="text" id="lname" name="lname"><br>
                
                <label for="lname">Rincian Infromasi yang Dibutuhkan:</label>
                <input type="text" id="lname" name="lname"><br>
                ...
                <label for="lname">Cara Mendapatkan Salinan Infromasi**:</label>
                <input type="checkbox" id="1" name="1" value="Bike" >
                <label for="1"> Mengambil Langsung</label><br>
                <input type="checkbox" id="2" name="1" value="Bike">
                <label for="2"> Kurir</label><br>
                <input type="checkbox" id="3" name="3" value="Bike">
                <label for="3">Pos </label><br>
                <input type="checkbox" id="4" name="4" value="Bike">
                <label for="4">Faksmili</label><br>
                <input type="checkbox" id="5" name="5" value="Bike">
